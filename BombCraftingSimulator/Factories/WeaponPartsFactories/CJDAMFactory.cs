...
{
    public class CJDAMFactory : IAbstractWeaponPartsFactory
    {
        ...
        public CJDAMFactory(int FABversion)
        {
            // Retrieve the blueprint for the specified version from the repository
            blueprint = CReasearchAndDevelopment.instance.GetBlueprint(WeaponFamilies.JDAM, FABversion);
        }
